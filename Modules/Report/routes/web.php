...
Route::group(['namespace' => '\Modules\Report\Http\Controllers\Backend', 'as' => 'backend.', 'middleware' => ['web', 'auth', 'can:view_backend'], 'prefix' => 'admin'], function () {
    ...
    */
    ...
    Route::get("$module_name/getTracking", ['as' => "$module_name.getTracking", 'uses' => "$controller_name@getTracking"]);
    Route::get("$module_name/trashed", ['as' => "$module_name.trashed", 'uses' => "$controller_name@trashed"]);
    Route::patch("$module_name/trashed/{id}", ['as' => "$module_name.restore", 'uses' => "$controller_name@restore"]);
    Route::post("$module_name/{id}/updateStatus", ['as' => "$module_name.updateStatus", 'uses' => "$controller_name@updateStatus"]);
