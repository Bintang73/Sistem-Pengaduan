                ...
                <table id="datatable" class="table table-bordered table-hover table-responsive-sm">
                    <thead>
                        <tr>
                            ...
                            <th>
                                @lang("reporter::text.name")
                            </th>
                            <th>
                                @lang("reporter::text.email")
                            </th>
                            <th>
                                @lang("reporter::text.phone_number")
                            </th>
                            <th>
                                @lang("reporter::text.updated_at")
                            </th>
                            <th>
                                @lang("reporter::text.created_by")
                            </th>
                            <th class="text-end">
                                @lang("reporter::text.action")
                            </th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $module_name_singular->phone_number }}
                            </td>
                            <td>
